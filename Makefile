...
DIAGRAMNODE = diagramnode.o \
  $(LINETEXT) $(STATEMENTTEXT) $(STRINGUTIL) $(SPLITLINES)
...
TAGGEDVALUEIO = taggedvalueio.o
WRAPPERSTATE = wrapperstate.o \
  $(PRINTINDENT) $(STRINGUTIL) $(STREAMPARSER) $(TAGGEDVALUEIO)
...
VIEWPORTCIRCLE = viewportcircle.o
DIAGRAMEDITOR = diagrameditor.o \
  $(DIAGRAM) $(NODETEXTEDITOR) $(DIAGRAMNODE) $(VIEWPORTCIRCLE) $(DIAGRAMIO)
